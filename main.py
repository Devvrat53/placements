...
def prediction(df_user, pkl_file):
    ...
    if prediction == 0:
        st.write("There is a {} that you'll not be placed".format(np.round(prediction_prob * 100), 3))
    else:
        st.write("There is a {} that you'll be placed!".format(np.round(prediction_prob * 100), 3))
